...
public class EServiceRegistrationSteps {
    ...
    /*@When("Enter Registration details from sheetname {string} and rownumber <RowNumber>")
    public void enterRegistrationDetailsFromSheetnameAndRownumberRowNumber(String sheetName, Integer rowNumber) {
        ExcelReader reader = new ExcelReader();
        String path = System.getProperty("User.dir");
        List<Map<String,String>> testData =
                null;
        try {
            testData = reader.getData(path+"\\SCDRegistration.xlsx", sheetName);
    ...
    public void enter_registration_details_from_sheetname_and_rownumber(String sheetName, Integer rowNumber) throws IOException, InvalidFormatException, InterruptedException {
        ExcelReader reader = new ExcelReader();
        String path = System.getProperty("user.dir");
        System.out.println("Path is:" +path);
        //List<Map<String,String>> testData =reader.getData(path+"\\SCDRegistration.xlsx",sheetName); ;
        List<Map<String,String>> testData =
                reader.getData("C:\\Users\\Nagaraj\\Desktop\\SCDRegistration.xlsx", sheetName);
